...
import "../ToggleSidebar/ToggleSidebar.css"
...
const ToggleSidebar = () => {
  ...
  return (
    <div className='primaryNav' id='togglePrimaryNav'>

        <CloseIcon 
            onClick={()=>toggleSidebarContext.setOpenMenu(false)}
            sx=
            {{
                position:'absolute',
                top:'1rem',
                    ...
                    <List>
                        <ListItem 
                            ...
                            onClick=
                            {
                                () => 
                                {
                                    toggleSidebarContext.setOpenMenu(false);
                                    navigate('/');
                                }
                            }
                        >
